...
import copy
import time
from MotionCapture_Files  import DataDescriptions
from MotionCapture_Files import MoCapData
...
class NatNetClient:
    # print_level = 0 off --> Logging is turned off
    # print_level = 1 on --> Logging is turned on
    # print_level = >1 on / print every nth mocap frame
    print_level = 0
    
    def __init__( self ):
        # Change this value to the IP address of the NatNet server.
        self.server_ip_address = "192.168.2.10"

        # Change this value to the IP address of your local network interface
        self.local_ip_address = "192.168.2.16"
